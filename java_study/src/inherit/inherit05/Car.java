...
public class Car {
	...
	int run() {
		...
		//if (frontLeftTire.roll() == false) {   //그냥
		if (tireArr[FRONT_LEFT_TIRE].roll() == false) {      //배열
		//if (tireList.get(0).roll() == false) {   //어리
			stop();
